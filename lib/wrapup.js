...
*/
    ...
    browser: function(callback){
        ...
        if (err) return this
        var self = this
        require('./output/browser')(this, function(err, code){
    ...
    amd: function(callback){
        ...
        if (err) return this
        var self = this
        require('./output/amd')(this, function(err){
            self.emit("end")
    ...
    qt: function(callback){
        ...
        if (err) return this
        var self = this
        require('./output/qt')(this, function(err, code){
            self.emit("data", code)
            self.emit("end")
            if (callback) callback(err, code)
        })
    ...
    graph: function(callback){
        ...
        if (err) return this
        var self = this
        require('./output/graph')(this, function(err, dot){
            self.emit("data", dot)
            self.emit("end")
            if (callback) callback(err, dot)
        })
        return this
    },
